...
const README_src = require('!file-loader?name=docs-dev/[name].[ext]!@/../README.md')
const axios使用规范_src = require('!file-loader?name=docs-dev/[name].[ext]!@/../docs/axios使用规范.md')
const 环境变量使用规范_src = require('!file-loader?name=docs-dev/[name].[ext]!@/../docs/环境变量使用规范.md')
